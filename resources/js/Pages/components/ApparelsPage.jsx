...
const ApparelsPage = ({ apparels, images, sizes, search, bests, bestImages }) => {
    ...
    const bestSelling = bests.map(best => {
        const bestImage = bestImages.filter(image => image.id_apparel == best.id_apparel);
            ...
            <div className="container w-full h-screen pt-28 px-8">
                    ...
                    <form onSubmit={handleSearch}>
                        <div className='flex items-center gap-3'>
                            <input type="text" name='search' onChange={handleSearchChange} placeholder='Search for Names, Brands, Sizes' className='border-black border-2 w-80'/>
                            <button type='submit'>
                    ...
                    </form>
                {
                    apparels.length > 0 ?
                        (
                            ...
                            <p className="text-2xl text-gray-400 text-center mt-12">No Apparel Yet!</p>
                        )
                }
            </div>
        </>
